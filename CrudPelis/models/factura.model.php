...
class Factura
{
    public function todos() // select * from factura
    {
        ...
        // Seleccionamos todos los campos necesarios para el reporte
        $cadena = "SELECT factura.idFactura, factura.Fecha, factura.Sub_total, factura.Sub_total_iva, factura.Valor_IVA, factura.Clientes_idClientes 
                   FROM `factura` 
                   INNER JOIN clientes ON factura.Clientes_idClientes = clientes.idClientes";
